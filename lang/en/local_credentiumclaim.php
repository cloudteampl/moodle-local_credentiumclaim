...
$string['privacy:metadata:local_credentiumclaim_status:credentialid'] = 'The Credentium® identifier of the credential itself, used to link to it in the wallet.';
...
$string['walleturl_help'] = 'Where learners open a credential they have already claimed, for example <code>https://wallet.credentium.com</code>. Normally leave this empty: the plugin learns the address the first time a learner claims a credential through Moodle. Fill it in only if claimed credentials show no "Open in wallet" button — which happens on a site where nobody has ever claimed through Moodle, so there was nothing to learn from.';
