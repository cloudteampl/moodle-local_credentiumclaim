...
$string['mycredentials_empty'] = 'No Credentium® credentials have been issued to you yet.';
$string['mycredentials_heading'] = 'My Credentium® credentials';
$string['mycredentials_intro'] = 'These digital credentials have been issued to you. Click "Claim" to save one to your Credentium® Wallet; the ones you have already collected stay listed below, so you can open them again at any time.';
$string['nav_mycredentials'] = 'My credentials';
$string['nav_mycredentials_count'] = 'My credentials ({$a})';
$string['openwallet'] = 'Open in wallet';
...
$string['privacy:metadata:local_credentiumclaim_status:credentialid'] = 'The Credentium® identifier of the credential itself, kept so a support query can be matched to Credentium®\'s records.';
...
$string['walleturl'] = 'Credentium® Wallet address';
$string['walleturl_detected'] = 'Detected automatically: {$a}. Leave the field above empty to keep using it.';
$string['walleturl_help'] = 'Base address of the Credentium® Wallet, for example <code>https://wallet.credentium.com</code>. Claimed credentials link to the learner\'s credential list there. Normally leave this empty: the plugin learns the address the first time a learner claims a credential through Moodle. Fill it in only if claimed credentials show no "Open in wallet" button — which happens on a site where nobody has ever claimed through Moodle, so there was nothing to learn from.';
