...
$string['report_notifyfailed'] = 'Could not send {$a} "ready to claim" notification(s) on the last run. Those learners still see the reminder in the user menu and banner when they log in; turn on debugging to see the cause in the server logs.';
