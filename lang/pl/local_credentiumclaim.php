...
$string['mycredentials_empty'] = 'Nie wystawiono Ci jeszcze żadnych poświadczeń Credentium®.';
$string['mycredentials_heading'] = 'Moje poświadczenia Credentium®';
$string['mycredentials_intro'] = 'Te poświadczenia cyfrowe zostały Ci wystawione. Kliknij „Odbierz”, aby zapisać poświadczenie w swoim Portfelu Credentium®; już odebrane pozostają na liście, więc możesz je w każdej chwili otworzyć ponownie.';
$string['nav_mycredentials'] = 'Moje poświadczenia';
$string['nav_mycredentials_count'] = 'Moje poświadczenia ({$a})';
$string['openwallet'] = 'Otwórz w portfelu';
...
$string['privacy:metadata:local_credentiumclaim_status:credentialid'] = 'Identyfikator samego poświadczenia w Credentium®, przechowywany po to, aby zgłoszenie do wsparcia dało się powiązać z rejestrami Credentium®.';
...
$string['report_checknow_failed'] = 'Nie udało się przeprowadzić sprawdzenia statusu. Włącz debugowanie, aby poznać przyczynę, lub sprawdź wynik ostatniego uruchomienia poniżej.';
...
$string['report_error_pending'] = 'W tym uruchomieniu nie udało się sprawdzić {$a} śledzonych poświadczeń; zachowują one ostatnio znany status i zostaną sprawdzone ponownie automatycznie.';
$string['report_error_server'] = 'Credentium® przyjął żądanie, ale nie zdołał go zrealizować. To błąd po stronie Credentium®, a nie konfiguracji tej strony. Wtyczka już ponowiła próbę i spróbuje ponownie przy następnym zaplanowanym sprawdzeniu — statusy uzupełnią się same, gdy usługa wróci do działania. Jeśli błąd się powtarza, skontaktuj się ze wsparciem Credentium® i podaj szczegóły techniczne powyżej.';
...
$string['report_notifyfailed'] = 'Nie udało się wysłać {$a} powiadomień „gotowe do odbioru” w ostatnim uruchomieniu (uczestnik może być zawieszony lub kanał dostarczania mógł zawieść). Ci uczestnicy nadal zobaczą przypomnienie w menu użytkownika i banerze po zalogowaniu.';
...
$string['testconnection_readscope_error'] = 'Nie udało się teraz zweryfikować dostępu do odczytu statusów. Może to być problem chwilowy, a nie konfiguracyjny. Szczegóły: {$a}';
...
$string['walleturl'] = 'Adres Portfela Credentium®';
$string['walleturl_detected'] = 'Wykryto automatycznie: {$a}. Zostaw pole powyżej puste, aby nadal go używać.';
$string['walleturl_help'] = 'Adres bazowy Portfela Credentium®, na przykład <code>https://wallet.credentium.com</code>. Odebrane poświadczenia odsyłają do listy poświadczeń uczestnika w portfelu. Zwykle zostaw puste: wtyczka sama poznaje ten adres przy pierwszym odbiorze poświadczenia przez Moodle. Uzupełnij go tylko wtedy, gdy przy odebranych poświadczeniach nie pojawia się przycisk „Otwórz w portfelu” — zdarza się to na stronie, na której nikt nigdy nie odbierał poświadczenia przez Moodle, więc nie było się z czego nauczyć.';
